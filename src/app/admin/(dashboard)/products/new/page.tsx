    ...
    <form onSubmit={handleSubmit} className="max-w-5xl space-y-8">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h2 className="font-serif text-2xl text-[#1E332D]">Add New Product</h2>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-2 space-y-8">
          <div className="bg-white border border-[#E0D9C8] shadow-sm p-6 space-y-6">
            <h3 className="font-serif text-lg text-[#1E332D] border-b border-[#E0D9C8] pb-4">Basic Information</h3>
          ...
          <div className="bg-white border border-[#E0D9C8] shadow-sm p-6 space-y-6">
            <h3 className="font-serif text-lg text-[#1E332D] border-b border-[#E0D9C8] pb-4">Pricing</h3>
        ...
        <div className="space-y-8">
          <div className="bg-white border border-[#E0D9C8] shadow-sm p-6 space-y-6">
            <h3 className="font-serif text-lg text-[#1E332D] border-b border-[#E0D9C8] pb-4">Organization</h3>
            <div>
          ...
          <div className="bg-white border border-[#E0D9C8] shadow-sm p-6 space-y-4">
            <h3 className="font-serif text-lg text-[#1E332D] border-b border-[#E0D9C8] pb-4">Product Image</h3>
            <div className="aspect-3/4 bg-neutral-50 border-2 border-dashed border-[#E0D9C8] flex items-center justify-center relative group">
              ...
              <div className="absolute inset-0 bg-black/60 opacity-0 group-hover:opacity-100 flex items-center justify-center transition-opacity">
                <button type="button" onClick={() => alert('Image upload not implemented for this demo')} className="bg-white text-[#1E332D] px-4 py-2 text-[10px] font-bold uppercase tracking-widest hover:bg-[#C8A366] hover:text-white transition-colors flex items-center gap-2">
